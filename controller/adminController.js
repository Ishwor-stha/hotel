...
module.exports.createAdmin = async (req, res, next) => {
    try {
        ...
        if (error.code === "ER_DUP_ENTRY") return next(new errorHandling(500, `An account with that email address already exists or there was an issue with the registration`))
        return next(new errorHandling(500, error.message))
    }
...
// @endpoint: localhost:4000/admin/logout-admin
